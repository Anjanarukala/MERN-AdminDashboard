...
export function UpdateUser(){
    ...
    useEffect(()=>{
            ...
            axios.get('https://mern-admindashboard.onrender.com/getUser/'+id)
        ...
        try {
            const result = await axios.put("https://mern-admindashboard.onrender.com/updateUser/" + id, { name, email, age });
            console.log(result);
            navigate('/');
        } catch (err) {
            console.error(err);
